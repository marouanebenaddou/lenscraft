...
function DesktopTile({
  ...
  return (
    ...
    >
      ...
      <div className="text-xs text-white/40">{perPeriod}</div>
      {discount && (
        <div
  ...
  return (
    <section id="pricing" className="bg-[#0E1115] py-24 px-6">
      <div className="max-w-5xl mx-auto">
        ...
        {/* ── MOBILE: 2 cards with plan selector ── */}
        ...
        {/* ── DESKTOP: individual tiles per plan ── */}
              ...
              <div className="grid grid-cols-3 gap-4">
                {goldPlans.map((p, i) => (
                  <DesktopTile
                    ...
                    separatorLabel="Exclusivités Gold"
                  />
                ))}
              </div>
            </div>
